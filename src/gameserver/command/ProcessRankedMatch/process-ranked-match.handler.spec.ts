...
describe("ProcessRankedMatchHandler", () => {
  ...
  //
  //   expect(
  //     ProcessRankedMatchHandler.computeMMRChange(randomUser().value, 15, true, diffDeviationFactor),
  //   ).toEqual(25);
  //
  //   expect(
  ...
  //   const loserMMR = 2000 * 5;
  //
  //   const diffDeviationFactor = ProcessRankedMatchHandler.calculateMmrDeviation(
  //     winnerMMR / 5,
  //     loserMMR / 5,
  //   );
  //
  ...
  it("should do calc default mmr change(with average diff), edge case 2", () => {
    ...
    const winnerChange = ProcessRankedMatchHandler.computeMMRChange(
      100,
      true,
      diffDeviationFactor,
      10,
    ...
    const loserChange = ProcessRankedMatchHandler.computeMMRChange(
      100,
      false,
      diffDeviationFactor,
      10,
